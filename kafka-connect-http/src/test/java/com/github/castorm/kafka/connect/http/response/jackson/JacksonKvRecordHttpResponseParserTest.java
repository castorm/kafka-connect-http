...
class JacksonKvRecordHttpResponseParserTest {
    ...
    void givenOneItem_thenKeyMapped() {
        ...
        givenRecords(Stream.of(record.withKey("key").withOffset(ImmutableMap.of( "endpoint", "topic"))));
    ...
    void givenOneItemWithNoKeyButOffset_thenKeyMappedFromOffset() {
        ...
        givenRecords(Stream.of(record.withKey(null).withOffset(ImmutableMap.of("key", "value", "endpoint", "topic"))));
    ...
    void givenOneItemWithNoNoKey_thenKeyDefault() {
        ...
        givenRecords(Stream.of(record.withKey(null).withOffset(ImmutableMap.of( "endpoint", "topic"))));
    ...
    void givenOneItem_thenValueMapped() {
        ...
        givenRecords(Stream.of(record.withBody("value").withOffset(ImmutableMap.of( "endpoint", "topic"))));
    ...
    void givenOneItem_thenTimestampMapped() {
        ...
        givenRecords(Stream.of(record.withTimestamp(timestampIso).withOffset(ImmutableMap.of( "endpoint", "topic"))));
    ...
    void givenOneItemWitNoTimestampButOffset_thenTimestampMappedFromOffset() {
        ...
        givenRecords(Stream.of(record.withTimestamp(null).withOffset(ImmutableMap.of("timestamp", timestampIso, "endpoint", "topic"))));
        given(timestampParser.parse(timestampIso)).willReturn(timestamp);
    ...
    void givenOneItemWithNoTimestamp_thenDefault() {
        ...
        givenRecords(Stream.of(record.withTimestamp(null).withOffset(ImmutableMap.of( "endpoint", "topic"))));
    ...
    void givenOneItem_thenOffsetMapped() {
        ...
        givenRecords(Stream.of(record.withOffset(ImmutableMap.of("offset-key", "offset-value", "endpoint", "value"))));
    ...
    void givenOneItem_thenKeyMappedToOffset() {
        ...
        givenRecords(Stream.of(record.withKey("value").withOffset(ImmutableMap.of( "endpoint", "topic"))));
